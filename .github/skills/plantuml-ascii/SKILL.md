...
| Problem | Solution |
|---------|----------|
| Garbled Unicode characters | Ensure terminal supports UTF-8 and has proper font |
| Diagram looks misaligned | Use fixed-width font (Courier, Monaco, Consolas) |
| Command not found | Install PlantUML or use Java JAR directly |
| Output file not created | Check file permissions, ensure PlantUML has write access |
